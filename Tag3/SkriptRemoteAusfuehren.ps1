...
Invoke-Command -FilePath .\SpeicherkostenBerechnenV1.ps1 `
 -ArgumentList $env:userprofile\Documents,1.5 -Session $S1

# Ausführen auf mehreren Remote-Computern
Invoke-Command -FilePath .\SpeicherkostenBerechnenV1.ps1 `
 -ArgumentList $env:userprofile\Documents,1.5 -Session $S1,$S1,$S1

# Ausführen als Job

Invoke-Command -FilePath .\SpeicherkostenBerechnenV1.ps1 `
 -ArgumentList $env:userprofile\Documents,1.5 -Session $S1,$S1,$S1 -AsJob
